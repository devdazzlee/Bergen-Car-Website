...
export default function InventoryClient({ vehicles }: { vehicles: Vehicle[] }) {
  ...
  return (
    <div className="bg-mist">
          ...
          >
            <div className="container-page flex items-center gap-3 py-2.5">
              ...
              <div className="no-scrollbar flex flex-1 gap-2 overflow-x-auto">
                ...
                >
                  <SelectTrigger aria-label="Price range" className={miniTrigger}>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                    {PRICE_RANGES.map((r, i) => (
                ...
                >
                  <SelectTrigger aria-label="Body style" className={miniTrigger}>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
      ...
      {/* body */}
      <div className="container-page grid gap-8 py-10 lg:grid-cols-[280px_1fr] lg:gap-10 lg:py-12">
        {/* desktop sidebar */}
        <aside className="hidden lg:block">
          ...
          >
            ...
            >
              <FilterFields f={f} set={set} models={models} />
            </motion.div>
          </motion.div>
        </aside>
        ...
        <div>
          <div className="mb-6 flex items-center justify-between gap-4">
            <p className="text-sm text-navy-600">
              ...
              {activeCount > 0 ? " match your filters" : " on the lot"}
            </p>
          ...
          {shown.length > 0 ? (
            ...
            >
              ...
              <p className="mx-auto mt-1 max-w-sm text-sm text-navy-600">
                Try widening your search — a bigger price range or a couple fewer
                filters usually does it. New cars come in every week.
              </p>
              <button
                onClick={clearAll}
