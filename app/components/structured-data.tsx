...
export default function StructuredData({ vehicles }: { vehicles: Vehicle[] }) {
  const graph = [
    ...
    },
    {
      ...
      name: "Bergen Car Company",
      description:
        "Used car dealership in Lodi, New Jersey offering pre-owned vehicles, financing, and trade-ins.",
      url: SITE_URL,
      telephone: "+1-973-928-6300",
      email: "sales@bergencarcompany.com",
      priceRange: "$$",
      ...
      hasMap: "https://www.google.com/maps?q=22+US+46+East,+Lodi,+NJ+07644",
      areaServed: [
        "Lodi NJ",
        "Hackensack NJ",
        "Clifton NJ",
      ...
      itemListElement: vehicles.slice(0, 12).map((v, i) => ({
        ...
        item: {
          ...
          offers: {
            ...
            description: `${currency(v.price)} — warrantied`,
          },
        },
      })),
    },
